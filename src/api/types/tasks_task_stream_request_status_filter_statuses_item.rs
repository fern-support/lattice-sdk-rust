...
pub enum TaskStreamRequestStatusFilterStatusesItem {
    StatusInvalid,
    StatusCreated,
...
impl Serialize for TaskStreamRequestStatusFilterStatusesItem {
...
impl<'de> Deserialize<'de> for TaskStreamRequestStatusFilterStatusesItem {
...
impl fmt::Display for TaskStreamRequestStatusFilterStatusesItem {
