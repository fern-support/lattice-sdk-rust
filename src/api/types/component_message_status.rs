...
pub enum ComponentMessageStatus {
    HealthStatusInvalid,
    HealthStatusHealthy,
    HealthStatusWarn,
    HealthStatusFail,
...
impl Serialize for ComponentMessageStatus {
...
impl<'de> Deserialize<'de> for ComponentMessageStatus {
...
impl fmt::Display for ComponentMessageStatus {
